...
enum AchievementCriteriaTypes
{
    ...
    ACHIEVEMENT_CRITERIA_TYPE_INTRO_AWAKE = 124,
    ACHIEVEMENT_CRITERIA_TYPE_INTRO_SURVIVE_INVASION = 125,
    ACHIEVEMENT_CRITERIA_TYPE_INTRO_CRAWL_TO_FREEDOM = 126,
    ACHIEVEMENT_CRITERIA_TYPE_INTRO_ROCKET_RIDE = 127,
    ACHIEVEMENT_CRITERIA_TYPE_INTRO_REACH_CAMP = 128,
