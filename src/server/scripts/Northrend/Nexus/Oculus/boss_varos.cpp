    ...
    public:
        ...
        class spell_varos_centrifuge_shield_AuraScript : public AuraScript
        {
            ...
            void OnApply(AuraEffect const* /*aurEff*/, AuraEffectHandleModes /*mode*/)
            {
                ...
                if (GetCaster()->HasFlag(UNIT_FIELD_FLAGS, UNIT_FLAG_TRUESIGHT|UNIT_FLAG_PASSIVE|UNIT_FLAG_OOC_NOT_ATTACKABLE|UNIT_FLAG_UNK_6))
                {
                    GetCaster()->ToCreature()->SetReactState(REACT_PASSIVE);
                    GetCaster()->SetFlag(UNIT_FIELD_FLAGS, UNIT_FLAG_TRUESIGHT|UNIT_FLAG_PASSIVE|UNIT_FLAG_OOC_NOT_ATTACKABLE|UNIT_FLAG_UNK_6);
                }
            }
            ...
            void OnRemove(AuraEffect const* /*aurEff*/, AuraEffectHandleModes /*mode*/)
            {
                ...
                GetCaster()->RemoveFlag(UNIT_FIELD_FLAGS, UNIT_FLAG_TRUESIGHT|UNIT_FLAG_PASSIVE|UNIT_FLAG_OOC_NOT_ATTACKABLE|UNIT_FLAG_UNK_6);
            }
